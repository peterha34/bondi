...
class MQ():
    ...
    def __init__(self, Ro=10, analogPin=0):
        ...
        self.AlcocholCurve = [2.3,0.53,-0.44] # This is simliar to smokecurve and will need adjustment. 
                                              # But for simulation purposes it should be ok
    ...
    def MQGetGasPercentage(self, rs_ro_ratio, gas_id):
        ...
        # To calculate alcohol concerntration
        elif ( gas_id == self.ALCOHOL ):
            return self.MQGetPercentage(rs_ro_ratio, self.AlcocholCurve)
        return 0
